...
const Button = ({
  ...
  if (isComment) {
    return (
      <div>
        <button onClick={() => setActiveComment && setActiveComment(true)} className={styles.btn__comment}></button>
      </div>
    );
  }
  if (isLike) {
    return (
      <div>
        <button className={styles.btn__like}></button>
      </div>
    );
  }
  if (isSend) {
  ...
  if (addSubTask) {
    return (
      <div>
        <button className={styles.addTask}>{content}</button>
      </div>
    );
  }
  if (status) {
    return (
      <div>
        <button className={changeStatus(status)}>{content}</button>
      </div>
    );
  }
  if (edit) {
    return (
      <div>
        <button className={styles.edit}>{content}</button>
      </div>
    );
  }
  if (deleteBtn) {
  ...
  return (
    <div>
      <button className={styles.squishy__neon}>{content}</button>
    </div>
  );
};
